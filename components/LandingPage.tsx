          ...
          <div className="flex-1 text-white text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <button
                ...
                className="bg-white text-[#2563EB] px-10 py-4 rounded-2xl font-black text-sm uppercase tracking-wider hover:bg-blue-50 transition-all active:scale-95 shadow-2xl shadow-black/20"
              >
                Start Planning
              </button>
              <div className="flex items-center gap-3 justify-center bg-black/20 backdrop-blur-md rounded-2xl px-4 py-2 border border-white/10">
                <div className="flex -space-x-3">
                  {[1, 2, 3].map(i => (
                    <img key={i} src={`https://i.pravatar.cc/100?img=${i + 40}`} className="w-8 h-8 rounded-full border-2 border-[#2563EB]" alt="User" />
                  ))}
                </div>
      ...
      <section className="bg-gray-50 py-20 border-t border-gray-100">
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
          <div className="p-4 group">
            <div className="w-16 h-16 bg-white rounded-2xl shadow-md flex items-center justify-center mx-auto mb-6 text-[#2563EB] group-hover:bg-[#2563EB] group-hover:text-white transition-all duration-300">
          ...
          <div className="p-4 group">
            ...
            <p className="text-sm text-gray-500 font-medium leading-relaxed">Smart, data-driven planning advice available 24/7 via Top Advisor AI.</p>
          </div>
        </div>
      </section>
    </div>
